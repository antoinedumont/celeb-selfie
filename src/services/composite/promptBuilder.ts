...
POV SELFIE RULES: This is a first-person POV shot. Do NOT show any phone, smartphone, hand holding device, or arm in the frame. The camera IS the viewer's eyes - pure POV perspective.

Ultra-realistic POV selfie with ${celebrityName}. First-person point-of-view shot - NO phone or arm visible. Wide-angle 24mm lens distortion. They are standing naturally in front of me at a comfortable distance, heads about 15-20cm apart like a real fan selfie, calm and charismatic expression, very recognizable facial features. They are wearing a simple, elegant outfit. Natural soft daylight with slight flash effect, realistic skin texture, sharp facial details, true-to-life colors. Slight background blur (bokeh), in their favorite city. The photo feels spontaneous, candid, and genuine, like a real casual encounter photo. High resolution, professional photography quality.
